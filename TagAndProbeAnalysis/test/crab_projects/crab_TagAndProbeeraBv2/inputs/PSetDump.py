...
process.muonexercise4tp = cms.EDAnalyzer("MuonExercise4TagProbe",
    TagTriggerList = cms.vstring('HLT_IsoMu30'),
    TriggerList = cms.vstring('HLT_IsoMu30')
)
...
process.TFileService = cms.Service("TFileService",
    ...
    fileName = cms.string('TagAndProbe_eraBv2.root')
)
...
process.GlobalTag = cms.ESSource("PoolDBESSource",
    ...
    globaltag = cms.string('94X_mcRun2_asymptotic_v0'),
